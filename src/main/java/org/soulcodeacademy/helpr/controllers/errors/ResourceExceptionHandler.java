...
// Quando acontece  um erro, esta classe decide como retornar a mensagem p/ o cliente.
@ControllerAdvice // Tem a capacidade de gerenciar os erros que acontecem.
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> recursoNaoEncontradoError(RecursoNaoEncontradoError erro, HttpServletRequest request) {
        ...
        response.setPath(request.getRequestURI()); // Define qual endpoint aconteceu a requisição.
