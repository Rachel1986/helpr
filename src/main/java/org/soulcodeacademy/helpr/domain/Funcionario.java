...
public class Funcionario extends Usuario {
    // Gerar uma coluna dtype para indicar qual a subclasse (Funcionario ou Cliente)
    ...
    private Cargo cargo; // se eu quiser mudar o cargo do funcionário basta mudar o objeto deste campo.
...
// Relacionamento Bidirecional = quando as duas entidades "se conhecem".
