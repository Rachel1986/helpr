...
public class TokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
     FilterChain filterChain) throws ServletException, IOException {
        ...
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(usuario.getUsername(),usuario
                .getPassword(), usuario.getAuthorities()));
                filterChain.doFilter(request, response);
        // Resumo: Extrair do cabeçalho as informações do token c/ base nessas informações, busca dados do usuário e
        // então indica para a segurança da aplicação que o usuário é válido. Os próximos filtros já irão conhecer o
        // usuário e permitir o acesso.
    }
    ...
    private boolean validarCabecalho(HttpServletRequest request) {
        ...
        String cabecalho = request.getHeader("Authorization");
        // O cabeçalho enviado pelo cliente é válido se possuir o
        //Authorization e o valor começar com "Bearer ......"
