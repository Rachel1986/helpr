...
@Component // vai instanciar automaticamente o TokenUtil
public class TokenUtil {
    ...
    public String gerarToken(String email, String perfil) {
        // System.currentTimeMillis() => Pega o momento atual em mls
    ...
    public boolean validarToken(String token) {
        // Caso ocorra erro na linha 43, o token passado é inválido:
        // Não foi passado por nós ou expirou.
        try {
